...
function ReportsPage() {
  ...
  const therapyTypes = [
    { type: 'CBT', sessions: Math.floor((analytics?.overview.totalSessions || 0) * 0.35), percentage: 35 },
    { type: 'EMDR', sessions: Math.floor((analytics?.overview.totalSessions || 0) * 0.22), percentage: 22 },
    { type: 'Family Therapy', sessions: Math.floor((analytics?.overview.totalSessions || 0) * 0.19), percentage: 19 },
    { type: 'Group Therapy', sessions: Math.floor((analytics?.overview.totalSessions || 0) * 0.14), percentage: 14 },
    { type: 'Other', sessions: Math.floor((analytics?.overview.totalSessions || 0) * 0.10), percentage: 10 }
  ];
